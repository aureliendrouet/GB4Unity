...
namespace StudioKurage.Emulator.Gameboy
{
    public partial class Cpu
    {
        ...
        static Instruction SWAPrHLm = (_) => { byte n = _.mmu.rb(_.hl); int r = (((n & 0x0F) << 4) | ((n & 0xF0) >> 4)); _.mmu.wb(_.hl, (byte)r); _.zf = r == 0; _.sf = false; _.hcf = false; _.cf = false; };

        static void SWAP   (Cpu _, ref byte r) { byte tmp = r; r = _.mmu.rb(_.hl); _.mmu.wb(_.hl, tmp); _.zf = r == 0; _.sf = false; _.hcf = false; _.cf = false; }
    }
}
