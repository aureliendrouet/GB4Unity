...
namespace StudioKurage.Emulator.Gameboy
{
    public partial class Cpu
    {
        ...
        static Instruction ADDHL  = (_) => { ADD(_, _.mmu.rb(_.hl)); };
        static Instruction ADDn   = (_) => { ADD(_, _.mmu.rb(_.pc++)); };
        ...
        static Instruction ADDSPn = (_) => { byte n = _.mmu.rb(_.pc); ushort sp = _.sp; int i = sp + n; _.sp = (ushort)i; _.zf = false; _.sf = false; _.hcf = ((sp ^ n ^ (i & 0xFFFF)) & 0x0010) == 0x0010; _.cf = ((sp ^ n ^ (i & 0xFFFF)) & 0x0100) == 0x0100; _.pc++; };
        ...
        static Instruction ADCHL = (_) => { ADC(_, _.mmu.rb(_.hl)); };
        static Instruction ADCn  = (_) => { ADC(_, _.mmu.rb(_.pc++)); };
        ...
        static Instruction SUBHL  = (_) => { SUB(_, _.mmu.rb(_.hl)); };
        static Instruction SUBn   = (_) => { SUB(_, _.mmu.rb(_.pc++)); };
        ...
        static Instruction SBCHL  = (_) => { SBC(_, _.mmu.rb(_.hl)); };
        static Instruction SBCn   = (_) => { SBC(_, _.mmu.rb(_.pc++)); };
        ...
        static Instruction ANDHL  = (_) => { AND(_, _.mmu.rb(_.hl));   };
        static Instruction ANDn   = (_) => { AND(_, _.mmu.rb(_.pc++)); };
        ...
        static Instruction ORHL  = (_) => { OR(_, _.mmu.rb(_.hl));   };
        static Instruction ORn   = (_) => { OR(_, _.mmu.rb(_.pc++)); };
        ...
        static Instruction XORHL  = (_) => { XOR(_, _.mmu.rb(_.hl));   };
        static Instruction XORn   = (_) => { XOR(_, _.mmu.rb(_.pc++)); };
        ...
        static Instruction INCHLm = (_) => { _.mmu.wb(_.hl, INC(_, _.mmu.rb(_.hl))); };
        ...
        static Instruction DECHLm = (_) => { _.mmu.wb(_.hl, DEC(_, _.mmu.rb(_.hl))); };
        ...
        static void ADC(Cpu _, byte n) { int c = _.cf ? 1 : 0; int i = _.a + n + c; _.zf = ((byte)i) == 0; _.sf = false; _.hcf = ((_.a & 0x0F) + (n & 0x0F) + c) > 0x0F; _.cf = i > 0xFF; _.a = (byte)i; }

        static void SUB(Cpu _, byte n) { byte a = _.a; _.a = (byte)(a - n); _.zf = _.a == 0; _.sf = true; _.hcf = ((_.a ^ n ^ a) & 0x10) != 0; _.cf = (a - n) < 0; }

        static void SBC(Cpu _, byte n) { int c = _.cf ? 1 : 0; int i = _.a - n - c; _.zf = ((byte)i) == 0; _.sf = true; _.hcf = (((_.a & 0x0F) - (n & 0x0F) - c) < 0x00); _.cf = i < 0x00; _.a = (byte)i; }

        static void AND(Cpu _, byte n) { _.a &= n; _.zf = _.a == 0; _.sf = false; _.hcf = true; _.cf = false; }

        static void OR(Cpu _, byte n)  { _.a |= n; _.zf = _.a == 0; _.sf = false; _.hcf = true; _.cf = false; }
